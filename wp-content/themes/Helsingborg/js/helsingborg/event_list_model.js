...
function EventPageModel(data) {
	...
	var filters = [{
		...
		Value: ko.observable(""),
		RecordValue: function(record) {
			return (record.Location != null) ? record.Location : "";
		}
	}, {
		Type: "calendar",
		Name: "Startdatum",
		...
		Value: ko.observable(""),
		RecordValue: function(record) {
			return (record.Date != null) ? record.Date : "";
		}
	}, {
		Type: "calendar",
		Name: "Slutdatum",
		...
		RecordValue: function(record) {
			return (record.EventTypesName != null) ? record.EventTypesName : "";
		}
	}];
...
function PagerModel(records) {
	...
	self.renderNoRecords = function() {
		var message =
			"<span data-bind=\"visible: pager.recordCount() == 0\">Hittade inga event.</span>";
