...
(function($, window, document, undefined) {
	...
	var Orbit = function(el, settings) {
		...
		self.update_active_link = function(index) {
			var link = $('[data-orbit-link="' + self.slides().eq(index).attr(
				'data-orbit-slide') + '"]');
		...
		self.build_markup = function() {
			...
			if (settings.bullets) {
				...
				self.slides().each(function(idx, el) {
					var bullet = $('<li>').attr('data-orbit-slide', idx).on('click', self
						.link_bullet);;
		...
		self.init = function() {
			...
			if (settings.next_on_click) {
				container.on('click', '.' + settings.slides_container_class +
					' [data-orbit-slide]', self.link_bullet);
			}
				...
				container.on('touchstart.fndtn.orbit', function(e) {
					...
					.on('touchmove.fndtn.orbit', function(e) {
						...
						if (typeof data.is_scrolling === 'undefined') {
							data.is_scrolling = !!(data.is_scrolling || Math.abs(data.delta_x) <
	...
	Foundation.libs.orbit = {
		...
		events: function(instance) {
			var orbit_instance = new Orbit(this.S(instance), this.S(instance).data(
				'orbit-init'));
