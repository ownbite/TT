...
function readpage(rscall,playerid) {
  ...
  the_player+="<param name='movie' value='http://media.readspeaker.com/flash/readspeaker20.swf?"+audioformat+"="+newrscall+"&autoplay=1&rskin=bump&text_play=Play&text_pause=Pause&text_stop=Stop&text_vol=Volume'>";
  ...
  the_player+="<embed src='http://media.readspeaker.com/flash/readspeaker20.swf?"+audioformat+"="+newrscall+"&autoplay=1&rskin=bump&text_play=Play&text_pause=Pause&text_stop=Stop&text_vol=Volume'";
  ...
  the_html="<div id='bottomlinks'><a href='#' onclick='showcontrols(\""+origrscall+"\",\""+playerid+"\");return false'>Settings</a> | <a href='"+origrscall+"&save=1' target='rs'>Download audio</a> | Speech-enabled by <a href='http://www.readspeaker.com'>ReadSpeaker</a></div>";
  the_html+="<div id='controls'></div>";
  the_html+="</td><td style='vertical-align: top;'><a href='#' onclick='closepage(\""+playerid+"\");return false'><img id='closebr' src='http://graphics.rspeak.com/images/wr/close.gif' border='0' alt='Close player'></a></td></tr></table>";
