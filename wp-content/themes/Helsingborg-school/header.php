                    ...
                    <div class="hero">
                        <div class="columns large-12 no-margin">
                            <ul class="hero-orbit" data-orbit data-options="animation:fade; timer_speed:10000; slide_number:false;">
                                ...
                                <li style="background-image:url('http://www.hd.se/Images/hdarchive/archive/01016/ST_Bal_Angelholm_2_1016216a.jpg');">
                                    <div class="caption">
                                        <div class="caption-content">
                                            <div class="row">
                                                <div class="columns large-12">
                                                    Treornas bal - en dag att minnas
                                                    <a class="read-more">Se bilderna från kvällen</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
