/**
 * Note: This script is a modified version
 * @author Henric Lind
 *
 * Original:
    ...
    init : function(options) {
        ...
        if(options.live !== undefined){
            ...
            $(".zselect#"+rel).on('change','input:checkbox',function(e){
                $(options.live).val( methods.getValue($("select[rel='"+rel+"']")) ).trigger('change');
            });
        }//end live
        ...
        if(options.addButton !== undefined){
          $('#'+id+' ul').append("<div class='wrapper'><input id='button' type='submit' value='Uppdatera' /></div>");
          $('#button').click(options.addButton);
          refreshPlaceholder(rel,options.placeholder,options.selectedText);
        }
