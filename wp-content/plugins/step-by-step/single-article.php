	...
	<div id="primary" class="content-area">
		<div id="content" class="site-content" role="main">
			...
			<?php
				...
				$string .= '<tr><td colspan="2" valign="top">'. _e('<strong><font color="red">This is only a preview. <br/>Use the shortcode to display this guide on a page or post.</font></strong>') .'</td></tr>';
