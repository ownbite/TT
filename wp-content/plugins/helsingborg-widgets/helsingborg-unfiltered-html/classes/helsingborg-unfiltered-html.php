...
function um_unfilter_roles_one_time() {
    ...
    if (is_user_logged_in()) $current_user->_init_caps(); // Re-prime the current user's caps
}

if (false !== strpos( __FILE__, MUPLUGINDIR )) add_action( 'init', 'um_unfilter_roles_one_time', 1 );
